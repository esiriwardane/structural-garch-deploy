...
function problem = createOptimization(inputData, options, startingParameters)
  problem = createOptimProblem( ...
    ...
    'objective', @(x) sgjr.likelihood(x, inputData.return, inputData.equity, inputData.debt, ...
                                      inputData.riskFree, inputData.tau, inputData.forecastType), ...
    'options', options ...
  );
...
function results = collectResults(parameters, inputData)
  ...
  ] = sgjr.likelihood(parameters, inputData.return, inputData.equity, inputData.debt, ...
                      inputData.riskFree, inputData.tau, inputData.forecastType);
